...
if (_newPlane) then
{
	["RS_INV_fnc_SpawnC47", 3, (format ["Plane (%1) is a Player Specific Plane", _vehicle]), true] call RS_fnc_LoggingHelper;
...
["RS_INV_fnc_SpawnC47", 3, (format ["Plane (%1) Created and Returned, Flying at Height %2", _vehicle, _height]), true] call RS_fnc_LoggingHelper;
